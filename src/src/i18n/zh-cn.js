const tr = {
   ...
   viewer: {
      ...
      'tip.delonestock-confirm': '确定删除股票：',
      't.stockcode': '股票代码',
      't.stockname': '股票名称',
      't.stocktag': '股票分类',
      't.close.ui': '关闭',
      ...
      't.do.captr': '资金走向分析',
      't.bookmarks': '收藏列表',
      't.bookmark.do.addtag': '添加标签',
      't.bookmark.default': '(默认)',
      't.bookmark.number': '{{num}} 个股票',
      'tip.bookmark.noitem': '标签没有关联股票',
      'tip.bookmark.dragto': '拖拽添加股票',
      't.bookmark.addtag.title': '添加新标签',
      't.bookmark.addtag.placeholder': '标签名称',
      't.bookmark.addtag.add': '添加',
      't.bookmark.addtag.cancel': '取消',
